...
<div class="modal fade border-radius-4" id="deleteBrand" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content deleteModal">
            <div class="modal-header deleteModal-header">
                <h3 class="modal-title text-center" id="exampleModalLabel">Delete Brand!</h3>
            </div>
